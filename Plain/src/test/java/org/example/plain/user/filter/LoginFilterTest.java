...
public class LoginFilterTest {
    ...
    public void passToAuthenticationManager() throws Exception{
        Mockito.doReturn(user).when(objectMapper).readValue(Mockito.any(InputStream.class), Mockito.any(Class.class));
        ...
        assertThat(chapter.getValue().getPrincipal()).isEqualTo(user.getUsername());
    }
    ...
    public void isAuthenticationSuccess() throws Exception{
        ...
        Mockito.when(authentication.getPrincipal()).thenReturn(new CustomUserDetails(new UserEntity(user)));
